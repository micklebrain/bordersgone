...
const ArticlePreview = (props) => {
    return (
        <div>
            ...
            <Link to="/newyorkcity/NYCSpeakeasiesArticle" class="articlePreview"> <img class="articleImage" src={speakeasy} alt="NYC speakeasies guide" /> </Link> <div> <div class="articleTitle">NYC speakeasies guide</div> <div> Jan 27, 2022 </div> </div>
        </div>
    );
};
